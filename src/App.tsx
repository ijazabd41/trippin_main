...
const PremiumFeatures = React.lazy(() => import('./pages/PremiumFeatures'));
...
const TestPlanGeneration = React.lazy(() => import('./pages/TestPlanGeneration'));
const TestDataInjection = React.lazy(() => import('./pages/TestDataInjection'));
                ...
                <ConditionalLayout>
                  <ErrorBoundary>
                    <Suspense fallback={<LoadingSpinner />}>
                      ...
                      <Route path="/test-plan" element={<TestPlanGeneration />} />
                      <Route path="/test-data" element={<TestDataInjection />} />
